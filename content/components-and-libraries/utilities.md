...
head:
  - - link
    - rel: canonical
      href: https://awesome-nestjs.com/components-and-libraries/utilities.html
  - - meta
    - name: description
  ...
  - - meta
    - name: og:url
      content: https://awesome-nestjs.com/components-and-libraries/utilities.html
  - - meta
    - name: og:image
...
- ![](https://img.shields.io/github/stars/shayan-shojaei/nestjs-carrot.svg?style=flat-square) [`nestjs-carrot`](https://github.com/AdirD/nestjs-context-logger) - A NestJS package that provides a RabbitMQ-based queue system, inspired by [`@nestjs/bullmq`](https://github.com/nestjs/bull).
